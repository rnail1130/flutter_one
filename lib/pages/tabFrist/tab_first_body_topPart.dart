  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
          border: Border(bottom:AppContent.BorderSideStyle)
      ),
    ...
    return Expanded(
      ...
      child: InkWell(
        child: Column(
          ...
          children: <Widget>[
            Image.asset(this.data[1],width: AppContent.topimagesWidth,),
            SizedBox(height:AppContent.topTextImage,),
            Text(this.data[0],style: AppContent.topText,)
          ],
        ),
        onTap: (){
          if(this.data[0] == "绑卡账户"){
