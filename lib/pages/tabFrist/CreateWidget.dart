...
class CreateWidget extends StatefulWidget {
  ...
  @override
  _CreateWidgetState createState() =>
      _CreateWidgetState(this.data, data_list: this.data_list);
}
...
class _CreateWidgetState extends State<CreateWidget> {
  ...
  void jumpMoreList(String more, String color, String name) {
    Navigator.push(
      ...
      new MaterialPageRoute(
          builder: (context) => ComPage(color, name, this.data_list)),
    );
  }
  ...
  List<Widget> isShowMore() {
    ...
    if (more == null || more.isEmpty) {
      ...
      cons.add(InkWell(
        child: Text(
          '更多',
          style: AppContent.mMore,
        ),
        onTap: () {
          jumpMoreList(
              this.data["more"], this.data["color"], this.data["title"]);
        },
      ));
      cons.add(Icon(
        Icons.chevron_right,
  ...
  List<Widget> createWidget() {
    ...
    content.add(Container(
      ...
      decoration: BoxDecoration(
          border: Border(
              top: AppContent.mBorderSideStyle,
              bottom: AppContent.mBorderSideStyle)),
      child: Row(
        children: <Widget>[
          Expanded(
            flex: 1,
            child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border(
                      left:
                          BorderSide(color: color(), width: AppContent.mWidth)),
                ),
                child: Row(
                  children: <Widget>[
                    SizedBox(
                      width: AppContent.topTextImage,
                    ),
                    Text(this.data["title"], style: AppContent.mtopText),
                  ],
                )),
          ),
          Expanded(
    ...
    for (var i = 1; i <= row; i++) {
      content.add(Container(
        ...
        decoration:
            BoxDecoration(border: Border(bottom: AppContent.mBorderSideStyle)),
        child: Row(
          children: tg(i),
        ),
      ));
    ...
    lre.forEach((Map) {
      con.add(Expanded(
        ...
        child: InkWell(
          onTap: () {
            jumpPage(
                Map['data_title'], Map['isjump'], Map['url'], Map['ischeck']);
          },
          child: Container(
            decoration: BoxDecoration(
                // color: Colors.red,
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        height: AppContent.mpzHight,
                      ),
                      Text(Map['sub_title'], style: AppContent.mpzSub),
                    ],
                  ),
                ),
                Expanded(
  ...
  Widget build(BuildContext context) {
    return Column(children: createWidget());
  }
}
