...
class LandscapeIndex extends StatefulWidget {
  final landscapeType;
  final landscapeName;
  LandscapeIndex(this.landscapeName, this.landscapeType);
...
class GetPageData {
  static getLandScapeListData(
      int _pagenum, String landscapeType, Function callback) async {
    var res = await httpManager.netFetch(
        hostAddres.getLandScapeListApi(),
        {
          'pageIndex': _pagenum,
          'type': landscapeType,
        },
