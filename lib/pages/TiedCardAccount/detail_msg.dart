...
class GetH5 extends StatefulWidget {
  GetH5({Key key, this.businessCode, this.ifsgin, this.titleName})
      : super(key: key);
  final businessCode;
  final ifsgin;
  final titleName;
...
class _GetH5State extends State<GetH5> {
  ...
  List<String> weikaitong = ["办理个人公积金查询", "办理个人医保查询", "办理企业医保查询"];
  ...
  Widget build(BuildContext context) {
    getFun(String msg) {
      ...
      switch (msg) {
        case "居民卡一键挂失":
          openWithBrowser("tel:0737-6666666");
          return;
        case "点击查看我的居民卡":
          alertMsg(null, null, "暂未添加", null);
          return;
        case "一键查询移动积分余额":
          openWithBrowser("sms:10086?body=JF");
          return;
        case "一键兑换移动消费券":
          showDialog<Null>(
            context: context,
        ...
        case "查看移动积分消费明细":
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => checkDeil("交易记录")));
          return;
        case "启动和包支付APP":
        ...
        case "和包账户支付密码重置":
          ...
          return;
        case "访问和包支付官网":
          openWithBrowser("https://www.cmpay.com");
          return;
        case "安装和飞信APP":
          openWithBrowser("http://feixin.10086.cn");
          return;
        case "购买居民卡VIP用户":
          alertMsg(null, null, "暂未添加", null);
          return;
    ...
    List<Widget> getHTML5() {
      ...
      switch (widget.businessCode) {
        case '1001': // 居民卡账户
          data = [
            ...
            H5Config(
                "text", null, "方法一：点击下方“居民卡一键挂失”按钮，提交您的个人账户信息和有效身份信息完成挂失。"),
        ...
        case '1002': // 身份证账户
          data = [
            ...
            H5Config(
                "text", null, "3. 公民在申请补领居民身份证期间，急需使用居民身份证的，可以申请领取临时居民身份证。"),
        ...
        case '1008': // 社保卡账户
          data = [
            ...
            H5Config("b", null, "方法三："),
            H5Config(
                "text", null, "在人社部门大厅的自助设备上面进行社保卡挂失，使用自助设备一般要通过刷身份证进行登陆。"),
            H5Config("b", null, "方法四："),
            H5Config("text", null,
                "携带本人有效身份证件（一般是二代身份证）直接去社保卡服务中心或者其他指定地点办理书面的挂失手续。"),
            H5Config("b", null, "方法五："),
        ...
        case '1009': // 残疾人证
          data = [
            ...
            H5Config(
                "text", null, "2. 申请人填写残疾人证挂失声明社区在公告栏内将残疾人证挂失声明张贴10日，挂失寻找。"),
            H5Config("text", null,
        ...
        case '1010': // 工会卡账户
          data = [
            ...
            H5Config("text", null,
                "1. 益阳工会卡可具备益阳居民卡的全部功能；同时使用智慧益阳APP可以办理查询市总工会相关业务。"),
            H5Config("text", null, "2. 使用益阳居民卡卡号；具有益阳居民卡统一标识，联名发布实体卡和虚拟卡。"),
            H5Config("text", null,
                "3. 请使用居民卡卡号登录智慧益阳APP，可通过智慧益阳APP查询各类用卡信息、使用各类卡功能。"),
            H5Config("text", null, ""),
            H5Config("text", null, ""),
          ];
          break;
        ...
        case '1016': // 咪咕娱乐账户
          data = [
            ...
            H5Config("text", null,
                "您可以在帐号页面更改登录的手机号码，更改前需要验证您的身份，您可以使用短信验证码这种验证方式。"),
            H5Config("text", null, ""),
          ];
          break;
        case '1017': // 和飞信账户
        ...
        case '1018': // 139邮箱账户
          data = [
            ...
            H5Config(
                "img", null, "assets/img/TiedCardAccount/tied_139yx01.png"),
            H5Config("text", null,
        ...
        case '1019': // 党员账户
          data = [
            ...
            H5Config(
                "text", null, "2. 培养考察情况是半年左右的时间考察一次，因此，两次考察日期间隔一般为六个月左右。"),
            H5Config("text", null,
        ...
        case '1021': // 居民卡VIP用户账户
          data = [
            ...
            H5Config(
                "text", null, "权益二：使用第三方支付方式（微信支付、支付宝）在智慧益阳APP进行缴费时免除服务费。"),
            ...
            H5Config(
                "text", null, "3. 益阳居民卡运营服务有限公司具有对“居民卡VIP用户”权益及服务享有最终解释权。"),
            H5Config("text", null, ""),
          ];
          break;
        case '102101': // 居民卡VIP用户账户
          data = [
            H5Config("ab", null, "居民卡VIP用户账户"),
            H5Config("text", null,
                "益阳居民卡用户可以通过购买开通“居民卡VIP用户”服务，“居民卡VIP用户”服务购买价格为居民卡移动消费券1000点/年（1250点移动积分）。购买后服务将绑定智慧益阳APP您当前登录的居民卡账户。"),
            ...
            H5Config("b", null, "第三步：购买居民卡VIP用户"),
            H5Config("text", null,
                "点击下方“已了解并确认购买”按钮，使用1000点居民卡移动消费券购买“居民卡VIP用户”服务。"),
            H5Config("a", null, "二、“居民卡VIP用户”服务权益"),
            H5Config("text", null, "权益一：免费使用智慧益阳APP提供的公共缴费服务和全部缴费支付方式。"),
            H5Config(
                "text", null, "权益二：使用第三方支付方式（微信支付、支付宝）在智慧益阳APP进行缴费时免除服务费。"),
        ...
        case '1024': // 医疗保险账户
          data = [
            H5Config("text", null,
                "益阳居民卡用户可以在APP和“一公里便民服务网点”商户处的商户终端，办理个人和企业医保查询业务。"),
      ...
      //居民卡 - 移动积分消费模块 不显示该信息
      if (widget.titleName != "移动积分消费") {
        dataC.add(Divider(height: 1.0));
        dataC.add(Padding(
      ...
      for (var i = 0; i < data.length; i++) {
        if (data[i].abtr == "ab") {
          //居民卡 - 移动积分消费模块 该信息居中显示
          if (widget.titleName == "移动积分消费") {
            dataC..add(Center(child: Text("${data[i].text}", style: abstyle)));
            continue;
          }
